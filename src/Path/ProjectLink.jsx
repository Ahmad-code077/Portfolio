          ...
          <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3  items-start justify-start'>
            {projectData.map((item) => {
              ...
              return (
                <div
                  key={id}
                  className='flex flex-col p-4 md:gap-3  justify-start gap-2 border border-gray-600 rounded-sm hover:scale-105 duration-300 ease-in-out h-full'
                >
                  <div>
                  ...
                  <img
                    className='rounded bg-slate-600 grow'
                    src={pImage}
                    alt='Project image'
                  />
